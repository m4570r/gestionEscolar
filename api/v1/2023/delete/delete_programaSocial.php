...
//echo "delete_programaSocial.php"; 
...
$sql = 'DELETE FROM programassociales WHERE id=:id';
...
try {
    ...
    if ($stmt->rowCount() === 0) {
        echo json_encode(['success' => false, 'message' => 'No se encontraron registros de programassociales con el id especificado.']);
    } else {
        // Devuelve un mensaje de éxito
        echo json_encode(['success' => true, 'message' => 'Registro de programa social eliminado con éxito']);
    }
