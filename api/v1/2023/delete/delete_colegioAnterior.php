...
//echo "delete_colegioAnterior.php"; 
...
$sql = 'DELETE FROM colegiosanteriores WHERE id=:id';
...
try {
    ...
    if ($stmt->rowCount() === 0) {
        echo json_encode(['success' => false, 'message' => 'No se encontraron registros en colegioAnterior con el id especificado.']);
    } else {
        // Devuelve un mensaje de éxito
        echo json_encode(['success' => true, 'message' => 'Registro de colegioAnterior eliminado con éxito']);
    }
