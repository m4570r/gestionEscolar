...
//echo "delete_documentoApoderado.php"; 
...
$sql = 'DELETE FROM documentosapoderado WHERE idAlumno=:idAlumno';
...
try {
    ...
    if ($stmt->rowCount() === 0) {
        echo json_encode(['success' => false, 'message' => 'No se encontraron documentos con el idAlumno especificado.']);
    } else {
        // Devuelve un mensaje de éxito
        echo json_encode(['success' => true, 'message' => 'Documentos eliminados con éxito']);
    }
