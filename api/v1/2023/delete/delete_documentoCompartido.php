...
//echo "delete_documentoCompartido.php"; 
...
$sql = 'DELETE FROM documentoscompartidos WHERE idAlumno=:idAlumno';
...
try {
    ...
    if ($stmt->rowCount() === 0) {
        echo json_encode(['success' => false, 'message' => 'No se encontraron documentos compartidos con el idAlumno especificado.']);
    } else {
        // Devuelve un mensaje de éxito
        echo json_encode(['success' => true, 'message' => 'Documentos compartidos eliminados con éxito']);
    }
