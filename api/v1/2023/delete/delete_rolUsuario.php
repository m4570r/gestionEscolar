...
$sql = 'DELETE FROM rolesusuario WHERE id=:id';
...
try {
    ...
    if ($stmt->rowCount() === 0) {
        echo json_encode(['success' => false, 'message' => 'No se encontraron registros de roles con el id especificado.']);
    } else {
        // Devuelve un mensaje de éxito
        echo json_encode(['success' => true, 'message' => 'Registro de rol eliminado con éxito']);
    }
