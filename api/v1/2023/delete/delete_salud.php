...
$sql = 'DELETE FROM salud WHERE idAlumno=:idAlumno';
...
try {
    ...
    if ($stmt->rowCount() === 0) {
        echo json_encode(['success' => false, 'message' => 'No se encontraron registros de salud con el idAlumno especificado.']);
    } else {
        // Devuelve un mensaje de éxito
        echo json_encode(['success' => true, 'message' => 'Registro de salud eliminado con éxito']);
    }
