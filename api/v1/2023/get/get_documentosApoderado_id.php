...
try {
    // Consulta SQL para obtener los documentos de un alumno específico por idAlumno
    $stmt = $pdo->prepare('SELECT idAlumno, certificadoEstudios, informePersonalidad, informeNotas, fotocopiaHojaVida, boletaAporte, certificadoMedico FROM documentosApoderado WHERE idAlumno = :idAlumno');
    ...
    if ($registroDocumentos) {
        ...
        echo json_encode(['success' => false, 'message' => 'No se encontraron documentos del apoderado con el idAlumno proporcionado']);
    }
