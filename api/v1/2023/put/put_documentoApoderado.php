...
//echo "put_documentoApoderado.php"; 
...
$sql = 'UPDATE documentosapoderado SET ';
$params = [];
$first = true;
...
try {
    ...
    echo json_encode(['success' => true, 'message' => 'Documentos del apoderado actualizados con éxito']);
