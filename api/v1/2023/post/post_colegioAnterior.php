...
try {
    // Consulta SQL para insertar un nuevo colegio
    $stmt = $pdo->prepare('INSERT INTO colegiosAnteriores (nombre) VALUES (:nombre)');
    ...
    echo json_encode(['success' => true, 'message' => 'Colegio añadido con éxito']);
