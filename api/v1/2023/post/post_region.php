...
try {
    // Consulta SQL para insertar una nueva región
    $stmt = $pdo->prepare('INSERT INTO regiones (nombre) VALUES (:nombre)');
    ...
    echo json_encode(['success' => true, 'message' => 'Región añadida con éxito']);
